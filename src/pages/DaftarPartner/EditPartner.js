                        ...
                        <table style={{width: '100%', marginLeft: 'unset'}} className="table-form">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type='number'className='input-text-ez' onChange={handleChange} defaultValue={detailPartner.mpartner_telp} name="phoneNumber" style={{width: '100%', marginLeft: 'unset'}} onKeyDown={(evt) => ["e", "E", "+", "-", ".", ","].includes(evt.key) && evt.preventDefault()} /></td>
                                </tr>
                                <br/>
                                <tr>
                        ...
                        <table style={{width: '100%', marginLeft: 'unset'}} className="table-form">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type='number'className='input-text-ez' onChange={handleChange} defaultValue={detailPartner.mpartner_npwp !== null ? detailPartner.mpartner_npwp : "-"} name="noNpwp" style={{width: '100%', marginLeft: 'unset'}} onKeyDown={(evt) => ["e", "E", "+", "-", ".", ","].includes(evt.key) && evt.preventDefault()} /></td>
                                </tr>
                                <br/>
                                <tr>
                        ...
                        <table style={{width: '100%', marginLeft: 'unset'}} className="table-form">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type='number'className='input-text-ez' onChange={handleChange} defaultValue={detailPartner.mpartner_direktur_telp} name="noHp" style={{width: '100%', marginLeft: 'unset'}} onKeyDown={(evt) => ["e", "E", "+", "-", ".", ","].includes(evt.key) && evt.preventDefault()} /></td>
                                </tr>
                                <br/>
                            </tbody>
                        </table>
                        ...
                        <table style={{width: '100%', marginLeft: 'unset'}} className="table-form">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type='number'className='input-text-ez' onChange={handleChange} defaultValue={detailPartner.mpartnerdtl_account_number} name="akunBank" style={{width: '100%', marginLeft: 'unset'}} onKeyDown={(evt) => ["e", "E", "+", "-", ".", ","].includes(evt.key) && evt.preventDefault()} /></td>
                                </tr>
                                <br/>
                                <tr>
