...
function AlokasiSaldo() {
    ...
    async function historyAlokasiSaldo(currentPage, isDescending, orderField) {
        try {
            ...
            console.log(ballanceAllocation, 'ini balance alokasi');
    ...
    console.log(isDesc.orderIdStatus, 'ini order status');
