        ...
        <div className="main-content mt-5" style={{padding: "37px 27px 37px 27px"}}>
            ...
            <div className="base-content-beranda">
                ...
                <div style={{fontWeight: 700}} className="d-flex justify-content-between align-items-center mx-3 my-1">
                    <div>{detailPayment.tpaylink_subpartner_id}</div>
                    <div className="ps-4">{convertToRupiah(detailPayment.tpaylink_amount)}</div>
                    <div className="d-flex justify-content-center align-items-center">
                        <div className="mx-1" style={{color: "#077E86"}}>Kunjungi</div>
                        <div className="mx-1">|</div>
                        <div className=" d-flex justify-content-center align-items-center"><img src={CopyIcon} alt="copy" className="me-1" /><span style={{color: "#077E86"}}>Salin</span></div>
                    </div>
                </div>
            </div>
            <div className="head-title">
                ...
                <table className="report-pie-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div className="mx-5" style={{fontWeight: 600, fontFamily: "Exo"}}>{detailPayment.mpaytype_name}</div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><div className="mx-5" style={{fontWeight: 600, fontFamily: "Exo"}}>{detailPayment.tpaylink_desc}</div></td>
                        </tr>
                        <tr>
            ...
            <div className='mb-5 mt-3' style={{ display: "flex", justifyContent: "end"}}>
                <button style={{ color:"#FFFFFF", fontFamily: "Exo", fontSize: 16, fontWeight: 900, alignItems: "center", padding: "12px 24px", gap: 8, width: 250, height: 45, background: "linear-gradient(180deg, #FF434D 0%, #B9121B 100%)", border: "0.6px solid #2C1919", borderRadius: 6 }}>
                    Tutup Payment Link
                </button>
            </div>
        </div>
