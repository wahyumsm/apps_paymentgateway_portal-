...
const FormInfoUsahaOutlet = (props) => {
    ...
    console.log(imageFileTempatUsaha.map((item, id) => {
        console.log(item.data.size, "item.data");
    }), "imageFileTempatUsaha");
    ...
    async function formDataSecondStepInfoUsahaBadanUsaha(businessType, businessLevel, profileId, namaPerusahaan, bentukperusahaan, descBentukPerusahaan, emailPerusahaan, namaBrand, kategoriUsaha, jumlahKasir, pendapatanPerTahun, alamat, kodePos, provinsi, kota, kecamatan, kelurahan, jenisToko, kepunyaanQris, imageOnlineShop, nmid, onlineShopUrl, step) {
        try {
                ...
                if (getData.data.response_data.results !== null) {
                    if (step === 3) {
                        if (Number(businessType) === 1) {
                            ...
                            history.push(`/pengaturan-merchant/${profileId}/103/${businessType}`)
                        }
                    } else if (step === 2) {
            ...
            <div className="main-content mt-5" style={{padding: "37px 27px 37px 27px"}}>
                ...
                <div className='pb-4 pt-3'>
                    <div className='d-flex justify-content-start align-items-center' style={{ marginLeft: 35, marginRight: 35 }}>
                        ...
                        {
                            (type === "1" || inputHandle.businessType === 1) ?
                            <>
                ...
                <div className='base-content mt-3'>
                   ...
                   <div className='d-flex justify-content-between align-items-center mt-4 pb-4' >
                        ...
                        <button 
                            ...
                            onClick={() => formDataSecondStepInfoUsahaBadanUsaha(type !== null ? type : inputHandle.businessType, 103, profileId === undefined ? 0 : profileId, inputHandle.namaPerusahaan, inputHandle.bentukPerusahaan, inputHandle.bentukPerusahaanLainnya, inputHandle.emailPerusahaan, inputHandle.namaBrand, selectedDataKategoriUsaha.length !== 0 ? selectedDataKategoriUsaha[0].value : 0, Number(inputHandle.jumlahKasir) > 1500 ? 0 : inputHandle.jumlahKasir, inputHandle.pendapatanPertahun, inputHandle.alamatUsaha, inputHandle.kodePos, dataKodePos.mprovince_name === undefined ? "" : dataKodePos.mprovince_name, dataKodePos.mcity_name === undefined ? "" : dataKodePos.mcity_name, dataKodePos.mdistrict_name === undefined ? "" : dataKodePos.mdistrict_name, dataKodePos.mvillage_name === undefined ? "" : dataKodePos.mvillage_name, jenisToko.join(), inputHandle.kepunyaanQris, imageFileTempatUsaha, inputHandle.nmid, inputHandle.onlineShopUrl, 3)}
                        >
                            Selanjutnya
                        </button>
                    </div>
