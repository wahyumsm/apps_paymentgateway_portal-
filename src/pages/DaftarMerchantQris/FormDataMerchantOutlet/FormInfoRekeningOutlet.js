                ...
                <div className='base-content mt-4'>
                    ...
                    <div className='d-flex justify-content-between align-items-center mt-4 pb-4' >
                        ...
                        <button 
                            ...
                            onClick={() => addFormDaftarSettlementHandler(dataMerchantSettlement?.mprofile_id, settleGroup, merchantNou, userNou, selectedDataBank.length !== 0 ? selectedDataBank[0].value : "", inputHandle.noRek, inputHandle.namaPemilikRek, dataMerchantSettlement?.mprofdtl_email === null ? "" : dataMerchantSettlement?.mprofdtl_email, dataMerchantSettlement?.mqrismerchsettle_id === null ? 0 : dataMerchantSettlement?.mqrismerchsettle_id, 300)} 
                        >
                            Konfirmasi
                        </button>
                    </div>
