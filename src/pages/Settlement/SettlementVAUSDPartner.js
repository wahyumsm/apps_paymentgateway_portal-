                                    ...
                                    <tr>
                                        <td>
                                            <button
                                                ...
                                                className={(selectedBankSettlementVAUSDPartner.length === 0) || (nomorRekeningSettlementVAUSDPartner.length === 0) || (namaPemilikRekeningSettlementVAUSDPartner.length === 0) || (nominalPengajuanSettlementVAUSDPartner === undefined || Number(nominalPengajuanSettlementVAUSDPartner) === 0 || sisaSaldoSettlementVAUSDPartner < 0) ? 'btn-ez' : 'btn-ez-on'}
                                                disabled={(selectedBankSettlementVAUSDPartner.length === 0) || (nomorRekeningSettlementVAUSDPartner.length === 0) || (namaPemilikRekeningSettlementVAUSDPartner.length === 0) || (nominalPengajuanSettlementVAUSDPartner === undefined || Number(nominalPengajuanSettlementVAUSDPartner) === 0 || sisaSaldoSettlementVAUSDPartner < 0)}
