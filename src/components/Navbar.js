        ...
        <div className="d-flex justify-content-between w-100">
          ...
          <Nav className="align-items-center">
            ...
            { //https://www.ezeelink.co.id/ezeepg/#/ezeepg/Disbursement/disbursementpage
              (user_role === "102" && (window.location.href === 'https://www.ezeelink.co.id/ezeepg/#/ezeepg/Disbursement/disbursementpage' || window.location.href === 'https://www.ezeelink.co.id/ezeepg/#/ezeepg/Disbursement/report' || window.location.href === 'https://www.ezeelink.co.id/ezeepg/#/ezeepg/disbursement-report'|| window.location.href === 'https://www.ezeelink.co.id/ezeepg/#/ezeepg/riwayattopup' || window.location.href === 'https://www.ezeelink.co.id/ezeepg/#/ezeepg/alokasisaldo')) && 
