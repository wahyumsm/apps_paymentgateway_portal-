                ...
                userAccessMenu.map((item) => {
                  return (
                    <NavItem
                      ...
                      link={(item.id === 10) ? Routes.DashboardOverview.path : (item.id === 11) ? Routes.Transactions.path : (item.id === 14) ? Routes.DaftarAgen.path : (item.id === 12) ? Routes.NotFound.path : (item.id === 15) ? Routes.DaftarPartner.path : (item.id === 13) ? Routes.RiwayatTransaksi.path : (item.id === 16) ? Routes.Invoice.path : ""}
                    />
                  )
                })
              }
