                        ...
                        item.detail.map(item2 => {
                          return (
                            ...
                            <NavItem
                              ...
                              link={(item2.id === 1101) ? Routes.VaDanPaymentLink.path : (item2.id === 1102) ? Routes.Disbursement.path : (item2.id === 1103) ? Routes.eWallet.path : (item2.id === 1104) ? Routes.RiwayatDirectDebit.path : (item2.id === 1105) ? Routes.SubAccount.path : (item2.id === 1108) ? Routes.RiwayatVAUSDPartner.path : (item2.id === 1106) ? Routes.QrisTransaksi.path : (item2.id === 1107) ? Routes.TransaksiQrisApi.path : (item2.id === 1601) ? Routes.VaDanPaymentLinkAdmin.path : (item2.id === 1602) ? Routes.DisbursementAdmin.path : (item2.id === 1603) ? Routes.eWalletAdmin.path : (item2.id === 1604) ? Routes.RiwayatDirectDebitAdmin.path : (item2.id === 1605) ? Routes.SubAccountAdmin.path : (item2.id === 1606) ? Routes.DisbursementTimeout.path : (item2.id === 1609) ? Routes.QrisTransaksiAdmin.path : (item2.id === 1610) ? Routes.TransaksiQrisApiAdmin.path : (item2.id === 1608) ? Routes.RiwayatVAUSDAdmin.path : (item2.id === 1701) ? Routes.Settlement.path : (item2.id === 1702) ? Routes.SettlementManual.path : (item2.id === 1703) ? Routes.ExcludeSettlementManual.path : (item2.id === 1704) ? Routes.SettlementVAUSDAdmin.path : (item2.id === 1705) ? Routes.QrisSettlement.path : (item2.id === 1706) ? Routes.UnsettledTransaction.path : (item2.id === 1901) ? Routes.ReNotifyVA.path : (item2.id === 1902) ? Routes.ReNotifyEwallet.path : (item2.id === 1903) ? Routes.ReNotifyQris.path : (item2.id === 2301) ? Routes.InvoiceDisbursementSubMenu.path : (item2.id === 2302) ? Routes.InvoiceVASubMenu.path : (item2.id === 2303) ? Routes.TransaksiTopup.path : (item2.id === 2304) ? Routes.RiwayatInvoice.path : (item2.id === 2401) ? Routes.InfoSaldoDanMutasi.path : (item2.id === 2403) ? Routes.ListRiwayatSubAccount.path : (item2.id === 3501) ? Routes.VAUSD.path : (item2.id === 3502) ? Routes.RiwayatFileSFTP.path : (item2.id === 3801) ? Routes.ReportLogRintis.path : (item2.id === 9901) ? Routes.NotFound.path : (item2.id === 9902) ? Routes.NotFound.path : ""}
                            /> :
